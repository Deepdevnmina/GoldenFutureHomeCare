...
public class AmazonSES {
	...
	final String FROM = "animmd13@gmail.com";

	// The subject line for the email.
	final String SUBJECT = "One last step to complete your registration with GoldenFutureHomeCareApp";
	...
	public void verifyEmail(ConsumerDto consumerDto) {
		...
		String htmlBodyWithToken = HTMLBODY.replace("$tokenValue", consumerDto.getEmailVerificationToken());
		String textBodyWithToken = TEXTBODY.replace("$tokenValue", consumerDto.getEmailVerificationToken());

		SendEmailRequest request = new SendEmailRequest()
				.withDestination(new Destination().withToAddresses(consumerDto.getEmail()))
